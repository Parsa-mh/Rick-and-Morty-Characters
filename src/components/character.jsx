...
const Character = ({ data }) => {
    ...
    return (
        <div className="col-5 col-md-3 col-sm-4 col-lg-2 mx-lg-3 d-flex flex-column justify-content-center align-items-center rounded-5" key={data.name} onClick={() => navigate(`/characters/${data.id}`)} style={{ overFlow: "hidden",cursor : "pointer" }}>
